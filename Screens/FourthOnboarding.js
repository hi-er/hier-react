...
import { StyleSheet, Text, View, TextInput, TouchableOpacity,Image, KeyboardAvoidingView, Keyboard,ActivityIndicator ,Alert} from 'react-native';
...
export default class FourthOnboarding extends React.Component {
  ...
  PostNewUser(){
    Keyboard.dismiss();
    if(this.state.firstName=="" || this.state.phoneNum=="" || this.state.minHourlyRate==0 || this.state.minSalary==0 || this.state.email=="" || this.state.password=="")
    {
      Alert.alert(
        "Incomplete!",
  ...
  .then(function(user){
   ...
   firestoreRef1.doc(user.user.uid).set({
  ...
  render(){
    ...
    return (
        ...
        <Text style={{padding:10,color:"#fff",fontSize:26,marginBottom:12,fontFamily:'SpartanBold'}}>you're almost in!</Text>
        <Text style={{color:"#fff",marginBottom:10,fontFamily:'SpartanMedium',fontSize:16,width:"90%",textAlign:"left"}}>what is your minimum hourly rate?</Text>
       <View style={styles.inputView} >
        ...
        <Text style={{color:"#fff",marginBottom:10,fontFamily:'SpartanMedium',fontSize:16,width:"90%",textAlign:"left"}}>what is your minimum annual salary?</Text>
       <View style={styles.inputView} >
        ...
        <Text style={{color:"#fff",marginBottom:10,fontSize:18,fontFamily:'SpartanMedium'}}>sign up</Text>
      ...
      <TouchableOpacity  style={styles.loginBtn} onPress={this.PostNewUser.bind(this)}>
      <Text style={{color:"#fff",fontFamily:"SpartanMedium",fontSize:22}}>sign up</Text>
        </TouchableOpacity>
